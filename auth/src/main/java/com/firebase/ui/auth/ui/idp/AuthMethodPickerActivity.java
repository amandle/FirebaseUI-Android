        ...
        for (IDPProviderParcel providerParcel : providers) {
            switch (providerParcel.getProviderType()) {
                case FacebookAuthProvider.PROVIDER_ID :
                    mIdpProviders.add(new FacebookProvider(this, providerParcel, mFlowParameters.additionalFacebookPermissions));
                    break;
                case GoogleAuthProvider.PROVIDER_ID:
                    mIdpProviders.add(new GoogleProvider(this, providerParcel, null, mFlowParameters.additionalGooglePermissions));
                    break;
