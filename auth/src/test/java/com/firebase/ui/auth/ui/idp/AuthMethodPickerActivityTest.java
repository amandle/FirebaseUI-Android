...
@Config(constants = BuildConfig.class, shadows = {FirebaseAuthWrapperImplShadow.class}, sdk = 21)
public class AuthMethodPickerActivityTest {
    ...
    @Test
    @Config(shadows = {FacebookProviderShadow.class, ActivityHelperShadow.class})
